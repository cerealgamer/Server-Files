...
RMenu.Add('callmanager', 'main', RageUI.CreateMenu("Call Manager", '~r~Terror Call Manager', 1300, 0, "stream", "adminmenu"))
...
RegisterNetEvent('TRP:NotifyAdmin')
AddEventHandler('TRP:NotifyAdmin', function()
    if isPlayerAdmin then
