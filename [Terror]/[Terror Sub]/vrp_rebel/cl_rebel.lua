RMenu.Add('vrpgunshops', 'main', RageUI.CreateMenu("Rebel", "~r~Rebel", 1300, 0, "stream", "adminmenu"))
...
RegisterNetEvent("TerrorRP:Replenish")
AddEventHandler("TerrorRP:Replenish", function()
...
Citizen.CreateThread(function()
    blip = AddBlipForCoord(2355.9123535156,3143.4782714844,48.208690643311)
