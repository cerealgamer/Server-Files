local PoliceRanks = {
    ...
    [7] = { Rank = "ChiefInspector", PayCheck = 60000 },
    [8] = { Rank = "Inspector", PayCheck = 60000 },
    [9] = { Rank = "Sergeant", PayCheck = 60000 },
    [10] = { Rank = "Constable", PayCheck = 60000 },
    [11] = { Rank = "PCSO", PayCheck = 60000 },
    [12] = { Rank = "Off Duty", PayCheck = 60000 },
}
    ...
    while (true) do
        ...
        if #(Coords - ClockOn_Coords) < 1.0 then
            if IsControlJustPressed(1, 51) then
                TriggerServerEvent('TerrorRP:CheckForPerm')
                Citizen.Wait(100)
...
RegisterNetEvent('TerrorRP:AllowPD')
AddEventHandler('TerrorRP:AllowPD', function()
    isPlayerOnDuty = true
end)
