...
cfg.MiscButtons = {
    ...
    ["Spawn Weapon"] = {function(self)
        TriggerEvent("SpawnWeapon")
    end, "player.weaponspawn", "Spawns you a weapon."},
    ["Give Armour"] = {function(self)
        TriggerEvent("GiveArmour")
    end, "player.armour", "Spawns you a weapon."},
