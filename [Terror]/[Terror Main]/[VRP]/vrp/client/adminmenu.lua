...
RMenu.Add('vRPAdmin', 'main', RageUI.CreateMenu("Terror Menu", "~r~Terror Admin Menu",1250,100, "stream", "adminmenu"))
...
RMenu.Add('vRPAdmin', 'entity',  RageUI.CreateSubMenu(RMenu:Get("vRPAdmin", "main")))
...
RageUI.CreateWhile(1.0, true, function()
    if RageUI.Visible(RMenu:Get('vRPAdmin', 'main')) then
        RageUI.DrawContent({ header = true, glare = true, instructionalButton = true}, function()
                ...
                --RageUI.Button("Entity Options", "", {}, true, function(Hovered, Active, Selected) end, RMenu:Get("vRPAdmin", "entity"))
        end)
    end
    if RageUI.Visible(RMenu:Get('vRPAdmin', 'misc')) then 
        RMenu:Get('vRPAdmin', 'misc'):SetTitle('Terror Misc Menu') 
        RMenu:Get('vRPAdmin', 'misc'):SetSubtitle("~b~Terror Misc Menu")
        RageUI.DrawContent({ header = true, glare = true, instructionalButton = true}, function()
    ...
    if RageUI.Visible(RMenu:Get('vRPAdmin', 'EntitysDeleted')) then 
        RMenu:Get('vRPAdmin', 'EntitysDeleted'):SetTitle('Terror Entity Menu') 
