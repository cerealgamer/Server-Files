...
RMenu.Add('vRPGarages', 'main', RageUI.CreateMenu("Garages", "~r~Garage Menu",1250,100, "stream", "adminmenu"))
...
RMenu:Get('vRPGarages', 'owned_vehicles'):SetSubtitle("~r~Vehicle Categories")
